    ...
    dropdown1: [
        ...
        dropdown2: [
          {
            name: "Add Client",
            link: "",
            dataBsTarget: "#add_client",
          },
          {
            name: "All Client",
            link: "/app/client/clients",
          },
        ],
      },

      {
        ...
        dropdown2: [
          {
            name: "Invoices",
            link: "/app/account/invoices",
          },
          {
            name: "Payments",
            link: "/app/account/payments",
          },
          {
            name: "Due",
            link: "/app/account/due",
          },
          {
            name: "Purchase",
            link: "/app/account/debit",
          },
          {
            name: "Credit",
            link: "/app/account/credit",
          },
          {
            name: "Debits",
            link: "/app/account/debit",
...

      {
        ...
        dropdown2: [
          {
            name: "Credit Report",
            link: "/app/reports/credit-reports",
          },
          {
            name: "Debit Report",
            link: "/app/reports/debit-reports",
          },
        ],
      },
        ...
        dropdown2: [
          {
            ...
            link: "/app/profile/employee-profile",
          },
          {
            name: "Add own Business",
            link: "",
          },
          {
            name: "Bill Design",
        ...
        >
          {sidebarData.map((value, index) => {
            return (
              ...
              >
                <Collapse accordion ghost={true} expandIconPosition={"end"}>
                  {value.dropdown1.map((value, index) => {
                    return (
                      <Panel
                        data-bs-target={
                          value.dataBsTarget && value.dataBsTarget
                        }
                        header={
                          <Link
                            style={{ textDecoration: "none", color: "black" }}
                        ...
                        showArrow={value.dropdown2 ? true : false}
                      >
                        <Collapse
                          accordion
                          ghost={true}
                          ...
                          destroyInactivePanel={true}
                        >
                          {value.dropdown2?.map((value, index) => {
                            return (
                              <Panel
                                header={
                                  <Link
                                ...
                                style={{ color: "black" }}
                                showArrow={value.dropdown3 ? true : false}
                              >
                                <Collapse
                                  accordion
                                  ghost={true}
                                  ...
                                  destroyInactivePanel={true}
                                >
                                  {value.dropdown3?.map((value, index) => {
                                    return (
                                      <Panel
                                        data-bs-target={
                                          value.dataBsTarget &&
